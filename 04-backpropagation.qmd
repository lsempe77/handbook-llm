...
positions = [0.12, 0.36, 0.60, 0.84]
labels = ["input x", "multiply\nby 3", "add 4", "loss"]
for xpos, label in zip(positions, labels):
    ...
    ax.text(xpos, 0.28, "effect on\nloss", ha="center", va="center", color="white", fontsize=9,
...
ax.text(0.5, 0.88, "first: calculate the loss", ha="center", color=blue)
ax.text(0.5, 0.06, "then: trace how earlier values affect that loss", ha="center", color=orange)
